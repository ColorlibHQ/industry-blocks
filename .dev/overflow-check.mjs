 ...
 *
 *   WP_URL=https://example.com INDUSTRY_PATHS=/,/contact/ node .dev/overflow-check.mjs
 *
 * @package Industry
 */
...
const site = process.env.WP_URL || 'http://127.0.0.1:9493';
const paths = ( process.env.INDUSTRY_PATHS || '/,/about/,/services/,/projects/,/contact/,/blog/,/bank-holiday-press-rebuild/,/category/case-studies/,/?s=steel,/no-such-page/' ).split( ',' ).filter( Boolean );
const widths = ( process.env.INDUSTRY_WIDTHS || '1400,1024,768,390' ).split( ',' ).map( Number );
