...
// INDUSTRY_PATTERNS says where the patterns actually are in that case.
const patterns = process.env.INDUSTRY_PATTERNS
	? resolve( process.env.INDUSTRY_PATTERNS )
	: resolve( here, '../patterns' );

const url = process.env.WP_URL || 'http://127.0.0.1:9493';
