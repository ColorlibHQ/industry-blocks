<?php
/**
 * Title: Projects: seven photographs
 * Slug: industry/projects-all
...
<p class="has-text-align-center">From a one-week toolroom refit to a two-year design and build.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:columns {"style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40","left":"var:preset|spacing|40"}}}} -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"360/380","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-project"} -->
<figure class="wp-block-image size-large industry-project"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/project-5.webp' ) ); ?>" alt="A blue steel boiler house under construction beside a green field" style="aspect-ratio:360/380;object-fit:cover"/><figcaption class="wp-element-caption"><strong>Biomass boiler house</strong> Design and build</figcaption></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"360/380","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-project"} -->
<figure class="wp-block-image size-large industry-project"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/project-6.webp' ) ); ?>" alt="Two yellow tower cranes against a pale sky" style="aspect-ratio:360/380;object-fit:cover"/><figcaption class="wp-element-caption"><strong>Harbourside logistics hub</strong> Steelwork</figcaption></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"lightbox":{"enabled":true},"aspectRatio":"360/380","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-project"} -->
<figure class="wp-block-image size-large industry-project"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/project-7.webp' ) ); ?>" alt="Tall stainless fermentation tanks lining both sides of a brewery hall" style="aspect-ratio:360/380;object-fit:cover"/><figcaption class="wp-element-caption"><strong>Brewery tank hall</strong> Food and drink</figcaption></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
