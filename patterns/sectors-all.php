<?php
/**
 * Title: Sectors: six photograph cards
 * Slug: industry/sectors-all
...
<h2 class="wp-block-heading has-text-align-center">What we do, sector by sector</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"textAlign":"center"}}} -->
<p class="has-text-align-center">Six industries, one team, and the same engineer on your job from start to finish.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-column"><!-- wp:group {"className":"industry-sector","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group industry-sector"><!-- wp:image {"aspectRatio":"360/250","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-sector__photo"} -->
<figure class="wp-block-image size-large industry-sector__photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/sector-4.webp' ) ); ?>" alt="A long warehouse aisle between blue racking, a forklift at the far end" style="aspect-ratio:360/250;object-fit:cover"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Warehousing and logistics</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Racking, dock levellers, sprinklers and slab repairs for distribution centres that cannot close for the work.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:group {"className":"industry-sector","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group industry-sector"><!-- wp:image {"aspectRatio":"360/250","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-sector__photo"} -->
<figure class="wp-block-image size-large industry-sector__photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/sector-5.webp' ) ); ?>" alt="Two engineers in hard hats beside a field of solar panels under a blue sky" style="aspect-ratio:360/250;object-fit:cover"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Energy and renewables</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Rooftop and ground-mounted solar, substations and battery rooms, from structural survey to grid connection.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:group {"className":"industry-sector","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group industry-sector"><!-- wp:image {"aspectRatio":"360/250","scale":"cover","sizeSlug":"large","linkDestination":"none","className":"industry-sector__photo"} -->
<figure class="wp-block-image size-large industry-sector__photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/sector-6.webp' ) ); ?>" alt="Polished stainless-steel process tanks and pipework in a white production hall" style="aspect-ratio:360/250;object-fit:cover"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"level":3,"fontSize":"large"} -->
<h3 class="wp-block-heading has-large-font-size">Food and drink</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Hygienic stainless pipework, tank farms and cleaning systems installed to the standard a food auditor checks.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
